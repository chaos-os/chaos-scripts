...
case $N in
	...
	sed -i "s|(load-theme 'doom-[a-zA-Z\-]* t)|(load-theme 'doom-dracula t)|"g ~/.emacs.d/modules/aesthetics.el
	...
	sed -i "s|(load-theme 'doom-[a-zA-Z\-]* t)|(load-theme 'doom-tomorrow-night t)|"g ~/.emacs.d/modules/aesthetics.el
	...
	sed -i "s|(load-theme 'doom-[a-zA-Z\-]* t)|(load-theme 'doom-nord t)|"g ~/.emacs.d/modules/aesthetics.el
	...
	sed -i "s|(load-theme 'doom-[a-zA-Z\-]* t)|(load-theme 'doom-gruvbox t)|"g ~/.emacs.d/modules/aesthetics.el
	...
	sed -i "s|(load-theme 'doom-[a-zA-Z\-]* t)|(load-theme 'doom-solarized-dark t)|"g ~/.emacs.d/modules/aesthetics.el
	...
	sed -i "s|(load-theme 'doom-[a-zA-Z\-]* t)|(load-theme 'doom-solarized-light t)|"g ~/.emacs.d/modules/aesthetics.el
	...
	sed -i "s|(load-theme 'doom-[a-zA-Z\-]* t)|(load-theme 'doom-monokai-classic t)|"g ~/.emacs.d/modules/aesthetics.el
	...
	sed -i "s|(load-theme 'doom-[a-zA-Z\-]* t)|(load-theme 'doom-oceanic-next t)|"g ~/.emacs.d/modules/aesthetics.el
